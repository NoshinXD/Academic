...
//        }
        ...
        //System.out.println("Pushed node count in Manhattan heurustic " + push_count);
        System.out.println("Expanded node count in Manhattan heurustic " + (pop_count - 1));
        //push_count = 0;
    ...
    public static ArrayList<Matrix> findPath(Matrix src, Matrix goal) {
        ...
        src.setCost(h.manhattan_distance(src, goal));
        src.setLevel(0);
        src.setType(-1);
...
//                    System.out.println("Parent of \n" + goDown + "is\n" + current);
                    ...
                    goDown.setCost(h.manhattan_distance(goDown, goal));
...
//                    System.out.println("Parent of \n" + goUp + "is\n" + current);
                    ...
                    goUp.setCost(h.manhattan_distance(goUp, goal));
...
//                    System.out.println("Parent of \n" + goRight + "is\n" + current);
                    ...
                    goRight.setCost(h.manhattan_distance(goRight, goal));
...
//                    System.out.println("Parent of \n" + goLeft + "is\n" + current);
                    ...
                    goLeft.setCost(h.manhattan_distance(goLeft, goal));
        ...
        //System.out.println("Pushed node count in Manhattan heurustic " + push_count);
        //System.out.println("Popped node count in Manhattan heurustic " + pop_count);
